...
def check_render_services():
    ...
    print("⚠️  Cannot check Render services programmatically")
...
def main():
    ...
    if has_local and has_webhook:
        ...
        print("⚠️  Local bot running - could conflict with Render")
        print("   Solution: Kill local Python processes")
    elif has_webhook:
        print("⚠️  Webhook set - only webhook mode should be used")
